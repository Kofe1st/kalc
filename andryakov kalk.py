...
def calculate():
	...
	compound_field.insert(10, round(CI,3)) #округление до 3 чисел после запятой
...
#колонки
	...
	label4.grid(row = 5, column = 0, padx = 10, pady = 10) #5, чтобы было ниже, потому что 4 на отправить
	...
	button1 = Button(root, text = "Отправить", bg = "brown1",
					foreground = "black", command = calculate)
